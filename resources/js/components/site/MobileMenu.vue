<template>
  <Teleport to="#teleport">
    <Transition name="menu">
      ...
      >
        <div
          class="grid w-full grid-cols-12 place-items-center bg-stone-200 px-3 py-2 md:bg-stone-50 md:py-3 md:px-6"
        >
          <i-ri:close-line
        ...
        <div class="mx-6 flex justify-evenly space-x-6 border-b border-stone-200/80 py-6 md:hidden">
          <InertiaLink :href="$page.props.lang_url">
            <i-ri:translate-2 class="icons text-2xl" />
          </InertiaLink>
  ...
  <div
    class="flex w-full place-items-center gap-6 px-3 py-2 md:grid md:grid-cols-12 md:gap-0 md:px-6 xl:hidden"
  >
    <div class="justify-self-start md:col-span-3">
      <i-ri:menu-line class="icons cursor-pointer text-2xl" @click="show = !show" />
    </div>
